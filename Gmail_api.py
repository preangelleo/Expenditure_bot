...
def read_emails(user=GMAIL_ADDRESS, app_password=GMAIL_APP_PASSWORD):
    ...
    for uid in uids[0].split():
        ...
        if 'receipt' in plain_text.lower() or 'recepit' in email_subject.lower() or 'invoice' in email_subject.lower() or 'invoice' in plain_text.lower() or 'bill' in email_subject.lower() or 'renewed' in email_subject.lower() or 'payment' in email_subject.lower():
