...
def display_daily_profit_take():
    ...
    with col2:
        df_monthly_profit = df_profit.groupby(['year_close', 'month_close'])['profit'].sum(numeric_only=True).reset_index()
    ...
    with col3:
        df_yearly_profit = df_profit.groupby(['year_close'])['profit'].sum(numeric_only=True).reset_index()
