...
COMMANDS = [
    ...
    {"command": "get_target_price_for_user", "description": "Get the next 3 target price for a given coin"},
    ...
    {"command": "limit_sell", "description": "Place a limit sell order for a coin at resistance price"},
    {"command": "limit_buy", "description": "Place a limit buy order for a coin at support price"},
    ...
    {"command": "reset_initial_funding", "description": "Reset the initial funding to a new amount"},
    ...
    {"command": "cancel_order_id", "description": "Cancel a given coin with orderId"},
    {"command": "cancel_all_buy", "description": "Cancel all buy orders"},
...
BOT_COMMAND_DICT = {
    ...
    'fpp': 'funding_position_price',
    'bpr': 'binance_pay_record',
    'cmp': 'calculate_missed_profit',
...
COINBASE_SYMBOL_LIST = ['GALA-USDT', 'METIS-USDT', 'NEST-USDT', 'RAD-USDT', 'GMT-USDT', 'ARPA-USDT', 'POWR-USDT', 'FORT-USDT', 'UST-USDT', 'MINA-USDT', 'LCX-USDT', 'LRC-USDT', 'DDX-USDT', 'ICP-USDT', 'PAX-USDT', 'RLY-USDT', 'RNDR-USDT', 'API3-USDT', 'MATIC-USDT', 'BIT-USDT', 'SUPER-USDT', 'ENJ-USDT', 'STG-USDT', 'SHPING-USDT', 'AUCTION-USDT', 'CLV-USDT', 'AGLD-USDT', 'SYLO-USDT', 'ORN-USDT', 'ERN-USDT', 'BOND-USDT', 'LINK-USDT', 'FIS-USDT', 'LQTY-USDT', 'BTC-USDT', 'ATOM-USDT', 'CRO-USDT', 'KSM-USDT', 'MATH-USDT', 'ETH-USDT', 'C98-USDT', 'ACH-USDT', 'SHIB-USDT', 'STX-USDT', 'QNT-USDT', 'SAND-USDT', 'VGX-USDT', 'ROSE-USDT', 'POLS-USDT', 'BICO-USDT', 'FLOW-USDT', 'QSP-USDT', 'ATA-USDT', 'FIDA-USDT', 'WLUNA-USDT', 'WAMPL-USDT', 'IDEX-USDT', 'CHZ-USDT', 'PERP-USDT', 'OP-USDT', 'FOX-USDT', 'MDT-USDT', 'AIOZ-USDT', 'FET-USDT', 'GNO-USDT', 'DOGE-USDT', 'POLY-USDT', 'HFT-USDT', 'HBAR-USDT', 'REQ-USDT', 'AXS-USDT', 'ENS-USDT', 'TRU-USDT', 'APT-USDT', 'DOT-USDT', 'ELA-USDT', 'ADA-USDT', 'DESO-USDT', 'ZEN-USDT', 'XLM-USDT', 'POND-USDT', 'JASMY-USDT', 'SPELL-USDT', 'SOL-USDT', 'TIME-USDT', 'MCO2-USDT', 'BADGER-USDT', 'BTRST-USDT', 'NEAR-USDT', 'WCFG-USDT', 'DIA-USDT', 'ALCX-USDT', 'TRAC-USDT', 'CTX-USDT', 'XRP-USDT', 'DYP-USDT', 'SUKU-USDT', 'XYO-USDT', 'FARM-USDT', 'MEDIA-USDT', 'BOBA-USDT', 'MASK-USDT', 'XCN-USDT', 'DREP-USDT', 'HOPR-USDT', 'COVAL-USDT', 'GAL-USDT', 'ASM-USDT', 'NCT-USDT', 'AVAX-USDT', 'INDEX-USDT', 'UPI-USDT', 'KRL-USDT', 'APE-USDT', 'PRQ-USDT', 'IMX-USDT']