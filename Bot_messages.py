...
ONE_PARAMETER_COMMAND_LIST = {
    ...
    'count_positions_amounts': {'function': count_positions_amounts, 'description': 'You need to input a coin symbol after this command, for example: \n/count_positions_amounts RSR\n/position_RSR'},
    ...
    'reset_initial_funding': {'function': reset_initial_funding_amount, 'description': 'You need to input a coin symbol after this command, for example: /reset_initial_funding 400000'},
    ...
    'price_resistant': {'function': get_resistant_price_for_user, 'description': 'You need to input a coin symbol after this command, for example: /pr MATIC'},
    'price_support': {'function': get_support_price_for_user, 'description': 'You need to input a coin symbol after this command, for example: /ps MATIC'},
